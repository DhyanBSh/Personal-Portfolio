  ...
  return (
    ...
    >
      <div className="mb-12 flex items-end justify-between gap-6 border-b border-current/20 pb-5 md:mb-16">
        <h2 id="trust-heading" className="text-4xl font-normal leading-none tracking-[-0.04em] md:text-6xl">
          Built on trust
        </h2>
      ...
      <div className="mt-20">
        ...
        <div className="relative overflow-hidden border-y border-current/15 py-7">
          <div className="flex w-max animate-[trust-marquee_32s_linear_infinite] items-center gap-12 pr-12 md:gap-20 md:pr-20">
            {partnerLogos.map((partner, index) => (
              <span
                key={`${partner}-${index}`}
                className="whitespace-nowrap text-xl font-medium tracking-[-0.04em] opacity-55 md:text-3xl"
              >
                {partner}
              </span>
            ))}
